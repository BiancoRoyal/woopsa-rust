...
# woopsa-rust
A pure Rust library to provide the core specs library of [Woopsa](http://www.woopsa.org/).

## Features

This woopsa library is a core library to just provide:
